...
public class MyDemoLoggingAspect {
	...
	public Object AroundGetFortune(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
		...
		//	e.printStackTrace();
			// returing the result --working
			//result ="Throwing exception from AroundGetFortune " ;
			
			// adding the code to rethrow the exception
			throw e ;
		...
		System.out.println("At Around Advise " + duration + "milisecs");
		return result;
	}
